...
<head>
	...
	<title>MASS Series Dining Chair | FIL</title>
<!-- head, meta tags, css ..-->
...
<div class="product page-outer js_container" data-scroll-section data-page-name="dining-chair" data-group-name="product" data-barba="container" data-barba-namespace="product">
    <section class="product__top section-main">
        ...
        <div class="product__top-ttl-outer page-inner">
            <h1 class="product__top-ttl section-main__ttl">MASS Series<br>Dining Chair</h1>
        </div>
        <div class="product__top-inner section-main__inner page-inner">
            <div class="product__top-subttl"><b>1490 €</b> + tax</div>
        ...
        <div class="product__info-inner page-inner">
            <div class="product__info-ticker">
                <div class="product__info-ticker-inner">
                    <div class="product__info-ticker-txt">Dining</div>
                </div>
                <div class="product__info-ticker-inner">
                    <div class="product__info-ticker-txt">Dining</div>
                </div>
            </div>
            <img src="../../dist/img/mass series dining chair/s1-intro.jpg" alt="rectangle" class="product__info-pic pic-rectangle--sm" data-scroll data-scroll-direction="horizontal"  data-scroll-speed="-2" data-scroll-repeat="true" >
            <div class="product__info-card info-card">
                <div class="info-card__content">
                    <h2 class="product__info-card-ttl">Details</h2>
                    <h3 class="product__info-card-subttl">MASS Series<br>Dining Chair</h3>
                    <div class="product__info-card-txt txt-content">
                        <div class="product__info-card-txt-part">
                            <b>Special edition of dinning chair made of charred solid Oguni cedar. 
                        ...
                        <ul class="product__info-card-txt-part">
                            ...
                            <li class="product__info-card-txt-part-ln">
                                <b>Size:</b> W590 D670 SH420 AH610
                            </li>
                            <li class="product__info-card-txt-part-ln">
    ...
    <section class="product__gallery"  data-scroll  data-scroll-speed="1" data-scroll-repeat="true">
        <div class="product__gallery-inner page-inner">
            <!-- GALLERY SLIDER -->
            <div  class="swiper-container gallery-slider  js_dining-chair-gallery-slider ">
                <div data-text="next" class="swipe-area swiper-wrapper gallery-slider__wrapper js_swipe-area">
                    <div class="swiper-slide gallery-slider__slide">
                        <img src="../../dist/img/mass series dining chair/s1-slide-1.jpg" alt="gallery-img" class="gallery-slider__slide-content">
                    </div>
                    <div class="swiper-slide gallery-slider__slide">
                        <img src="../../dist/img/mass series dining chair/s1-slide-2.jpg" alt="gallery-img" class="gallery-slider__slide-content">
                    </div>
                    <div class="swiper-slide gallery-slider__slide">
                        <img src="../../dist/img/mass series dining chair/s1-slide-3.jpg" alt="gallery-img" class="gallery-slider__slide-content">
                    </div>
                </div>
                <div class="gallery-slider__itms">
                    <div class="swiper-pagination js_dining-chair-gallery-slider-pagination"></div>
                    <div class="gallery-slider__itms-fraction js_dining-chair-gallery-slider-indx">01</div>
                </div>
            </div>
            <!-- GALLERY SLIDER END -->
        </div>
