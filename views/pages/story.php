...
<head>
	...
	<title>Story | FIL</title>
<!-- head, meta tags, css ..-->
<?php include "../main-parts/top-part.php" ?>
<!-- head, meta tags, css .. end-->
<div class="story page-outer js_container" data-scroll-section data-scroll  data-page-name="story" data-group-name="page" data-barba="container" data-barba-namespace="page">
        ...
        <div class="story__about-inner page-inner">
            <div class="swiper-container double-slider-info info-card js_story-double-slider-info">
                ...
                <div class="double-slider__itms">
                    <div class="swiper-pagination js_story-double-slider-pagination"></div>
                    <div class="double-slider__itms-fraction js_story-double-slider-indx">01</div>
                </div>
            </div>
        </div>
        <!-- DOUBLE SLIDER END -->
