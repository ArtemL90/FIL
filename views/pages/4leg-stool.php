...
<head>
	...
	<title>MASS Series 4leg Stool | FIL</title>
<!-- head, meta tags, css ..-->
<?php include "../main-parts/top-part.php" ?>
<!-- head, meta tags, css .. end-->
<div class="product page-outer js_container" data-scroll-section data-page-name="4leg-stool" data-group-name="product" data-barba="container" data-barba-namespace="product">
    <section class="product__top section-main">
        <div class="product__top-backgrd">
            <img src="../../dist/img/mass series 4leg stool/s4-hero-d.jpg" alt="backgrd" class="product__top-backgrd-img"  data-scroll  data-scroll-speed="2" data-scroll-repeat="true">
        </div>
        ...
        <div class="product__top-inner section-main__inner page-inner">
            <div class="product__top-subttl"><b>1244 €</b> + tax</div>
    ...
    <section class="product__info">
        <div class="product__info-inner page-inner">
            ...
            <img src="../../dist/img/mass series 4leg stool/s4-intro.jpg" alt="rectangle" class="product__info-pic pic-rectangle--sm" data-scroll data-scroll-direction="horizontal"  data-scroll-speed="-2" data-scroll-repeat="true" >
    ...
    <section class="product__gallery"  data-scroll  data-scroll-speed="1" data-scroll-repeat="true">
        <div class="product__gallery-inner page-inner">
            <!-- GALLERY SLIDER -->
            <div  class="swiper-container gallery-slider  js_4leg-stool-gallery-slider ">
                <div data-text="next" class="swipe-area swiper-wrapper gallery-slider__wrapper js_swipe-area">
                    <div class="swiper-slide gallery-slider__slide">
                        <img src="../../dist/img/mass series 4leg stool/s4-slide-1.jpg" alt="gallery-img" class="gallery-slider__slide-content">
                    </div>
                    <div class="swiper-slide gallery-slider__slide">
                        <img src="../../dist/img/mass series 4leg stool/s4-slide-2.jpg" alt="gallery-img" class="gallery-slider__slide-content">
                    </div>
                    <div class="swiper-slide gallery-slider__slide">
                        <img src="../../dist/img/mass series 4leg stool/s4-slide-3.jpg" alt="gallery-img" class="gallery-slider__slide-content">
                    </div>
                </div>
                <div class="gallery-slider__itms">
                    <div class="swiper-pagination js_4leg-stool-gallery-slider-pagination"></div>
                    <div class="gallery-slider__itms-fraction js_4leg-stool-gallery-slider-indx">01</div>
                </div>
            </div>
            <!-- GALLERY SLIDER END -->
        </div>
