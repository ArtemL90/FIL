...
<head>
	...
	<title>MASS Series Coathanger | FIL</title>
<!-- head, meta tags, css ..-->
<?php include "../main-parts/top-part.php" ?>
<!-- head, meta tags, css .. end-->
<div class="product page-outer js_container" data-scroll-section data-page-name="coat-tree" data-group-name="product" data-barba="container" data-barba-namespace="product">
    <section class="product__top section-main">
        <div class="product__top-backgrd">
            <img src="../../dist/img/mass series coathanger/s6-hero-d.jpg" alt="backgrd" class="product__top-backgrd-img"  data-scroll  data-scroll-speed="2" data-scroll-repeat="true">
        </div>
        <div class="product__top-ttl-outer page-inner">
            <h1 class="product__top-ttl section-main__ttl">MASS Series<br>Coathanger</h1>
        </div>
        <div class="product__top-inner section-main__inner page-inner">
            <div class="product__top-subttl"><b>1800 $</b> + tax</div>
        ...
        <div class="product__info-inner page-inner">
            <div class="product__info-ticker">
                <div class="product__info-ticker-inner">
                    <div class="product__info-ticker-txt">Coathanger</div>
                </div>
                <div class="product__info-ticker-inner">
                    <div class="product__info-ticker-txt">Coathanger</div>
                </div>
            </div>
            <img src="../../dist/img/mass series coathanger/s6-intro.jpg" alt="rectangle" class="product__info-pic pic-rectangle--sm" data-scroll data-scroll-direction="horizontal"  data-scroll-speed="-2" data-scroll-repeat="true" >
            <div class="product__info-card info-card">
                <div class="info-card__content">
                    <h2 class="product__info-card-ttl">Details</h2>
                    <h3 class="product__info-card-subttl">MASS Series<br>Coathanger</h3>
                    <div class="product__info-card-txt txt-content">
                        <div class="product__info-card-txt-part">
                            <b>Special edition of coathanger made of charred solid Oguni cedar. 
            ...
            <div  class="swiper-container gallery-slider  js_coat-tree-gallery-slider ">
                <div data-text="next" class="swipe-area swiper-wrapper gallery-slider__wrapper js_swipe-area">
                    <div class="swiper-slide gallery-slider__slide">
                        <img src="../../dist/img/mass series coathanger/s6-slide-1.jpg" alt="gallery-img" class="gallery-slider__slide-content">
                    </div>
                    <div class="swiper-slide gallery-slider__slide">
                        <img src="../../dist/img/mass series coathanger/s6-slide-2.jpg" alt="gallery-img" class="gallery-slider__slide-content">
                    </div>
                    <div class="swiper-slide gallery-slider__slide">
                        <img src="../../dist/img/mass series coathanger/s6-slide-3.jpg" alt="gallery-img" class="gallery-slider__slide-content">
                    </div>
                </div>
