        ...
        <div class="footer__part">
           ...
           <nav class="footer__navigation navigation footer__part-even">
                <ul class="footer__navigation-lst navigation__lst">
                    ...
                    <li class="footer__navigation-lst-line navigation__lst-line">
                        <a href="#" class="footer__navigation-lst-line-lnk navigation__lst-line-lnk">Story</a>
                    </li>
                </ul>
            </nav>
        </div>
        <div class="footer__social">
            <a href="#" class="footer__social-itm">Twitter</a>
            <a href="#" class="footer__social-itm">Facebook</a>
            <a href="#" class="footer__social-itm">Instagram</a>
        </div>
        <div class="footer__part">
            <div class="footer__copyright">© 2020 FIL</div>
            <button class="footer__btn round-btn footer__part-even">Connect</button>
        </div> 
    </div>      
</footer>